/*
Package gofpdi wraps the gofpdi PDF library to import existing PDFs as templates. See github.com/arpossatto/gofpdi
...
import (
	realgofpdi "github.com/arpossatto/gofpdi"
	"io"
)
